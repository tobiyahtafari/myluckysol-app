      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)} className="space-y-6 mt-6">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="earnings" className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center justify-center py-2 px-1 sm:px-2" data-testid="tab-earnings">
              <Coins className="w-4 h-4" />
              <span className="text-[10px] sm:text-sm font-medium leading-tight">Earnings</span>
            </TabsTrigger>
            <TabsTrigger value="luck" className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center justify-center py-2 px-1 sm:px-2" data-testid="tab-luck">
              <TrendingUp className="w-4 h-4" />
              <span className="text-[10px] sm:text-sm font-medium leading-tight">Luck Score</span>
            </TabsTrigger>
            <TabsTrigger value="streaks" className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center justify-center py-2 px-1 sm:px-2" data-testid="tab-streaks">
              <Flame className="w-4 h-4" />
              <span className="text-[10px] sm:text-sm font-medium leading-tight">Streaks</span>
            </TabsTrigger>
          </TabsList>
