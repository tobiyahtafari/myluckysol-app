...
export default function Play() {
  ...
  const { selectedMode, selectedWager, setSelectedMode, setSelectedWager, playTab, setPlayTab } = useGameStore();
  ...
  return (
    ...
    <div className="min-h-screen py-8 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <Tabs value={playTab} onValueChange={(v) => setPlayTab(v as "join" | "live")} className="space-y-8">
